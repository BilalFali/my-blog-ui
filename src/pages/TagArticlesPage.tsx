...
import { blogApi, tagsApi, type Post } from '../services/api';
...
const TagArticlesPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTagArticles = async () => {
      ...
      try {
        ...
        // Get tag info
        const tag = await tagsApi.getBySlug(slug);
        if (tag) {
          setTagName(isArabic ? tag.name_ar : tag.name_en);
        }

        // Get articles with this tag
        const result = await blogApi.getPosts(1, 100, undefined, slug);
  ...
  if (loading) {
    return <ArticleListSkeleton iconColor="purple" />;
  }
          ...
          <div className="flex items-start gap-4 mt-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">
                {isArabic ? 'جميع المقالات المصنفة تحت هذا الوسم' : 'All articles tagged with'} {tagName}
              </p>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 cursor-pointer"
              >
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {searchQuery 
                ...
                : (t('noArticlesWithTag') || 'No articles with this tag yet')
              }
            </p>
          </div>
        ) : (
