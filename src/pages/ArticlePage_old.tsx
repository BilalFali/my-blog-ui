...
const ArticlePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <SocialMetaTags
        title={title}
        description={post.excerpt_en || post.excerpt_ar || content.substring(0, 160)}
        image={featuredImage}
        url={shareUrl}
        type="article"
        ...
        <article>
          ...
          <div className="bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 dark:from-blue-500/5 dark:via-purple-500/5 dark:to-pink-500/5 rounded-3xl shadow-xl p-6 md:p-8 mb-8 border-2 border-blue-200/50 dark:border-gray-700/50 backdrop-blur-sm">
            <ShareButtons 
              url={shareUrl}
              title={shareTitle}
              description={post.excerpt_en || post.excerpt_ar || ''}
            />
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8 mb-8 border border-gray-100 dark:border-gray-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
              {isArabic ? 'تفاعل مع المقال' : 'How was this article?'}
            </h3>
            <ReactionButtons articleId={post.slug} />
          </div>

          {/* Comments Section */}
          <div className="mb-8">
            <CommentSection articleId={post.slug} />
          </div>
        </article>
